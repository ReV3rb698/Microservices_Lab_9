...
const getStats = () => {
    ...
    makeReq(ANALYZER_API_URL.checks, (result) => {
        ...
        if (result.last_updated) {
            ...
            document.getElementById("missing-db-count").innerText = result.not_in_db ? result.not_in_db.length : 0;
            document.getElementById("missing-queue-count").innerText = result.not_in_queue ? result.not_in_queue.length : 0;
    });
};
